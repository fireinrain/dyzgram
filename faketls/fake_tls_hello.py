...
from .encryption_helper import default_random, gen_x25519_public_key
...
class MTProxyFakeTLSClientCodec:
    ...
    def gen_set_session_id(self):
        self.client_hello('session_id', default_random.getrandbytes(32))
    ...
    def gen_set_key_share(self):
        self.client_hello('ext_key_share_exchange', gen_x25519_public_key())
