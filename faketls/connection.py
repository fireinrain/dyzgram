...
import asyncio
import socket
from .fake_tls_hello import MTProxyFakeTLSClientCodec

from telethon.network.connection.tcpmtproxy import ConnectionTcpMTProxyRandomizedIntermediate

from faketls import FakeTLSStreamWriter, FakeTLSStreamReader
...
class ConnectionTcpMTProxyFakeTLS(ConnectionTcpMTProxyRandomizedIntermediate):
    def __init__(self, ip, port, dc_id, *, loggers, proxy=None, local_addr=None):
        self.fake_tls_cdc = MTProxyFakeTLSClientCodec(proxy[2])
